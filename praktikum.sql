...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 20, 2021 at 11:54 AM
...
(11, 'System Analyst', 2400000, 500000, 40000),
(12, 'Project Manager', 2300000, 450000, 38000),
(13, 'Senior Programmer', 2200000, 400000, 36000),
(14, 'Junior Programmer', 2100000, 350000, 34000),
(15, 'Intern', 1000000, 100000, 20000),
(16, 'System Analyst', 2400000, 500000, 40000),
(17, 'Project Manager', 2300000, 450000, 38000),
(18, 'Senior Programmer', 2200000, 400000, 36000),
(19, 'Junior Programmer', 2100000, 350000, 34000),
(20, 'Intern', 1000000, 100000, 20000),
(21, 'Untuk Coba Hapus', 999, 999, 999),
(22, 'Untuk Coba Hapus', 999, 999, 999),
(23, 'Untuk Coba Hapus', 999, 999, 999);
...
--
-- Table structure for table `tabel lokasi`
--

CREATE TABLE `tabel lokasi` (
  `id` int(11) NOT NULL,
  `nama_lokasi` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Indexes for table `tabel lokasi`
--
ALTER TABLE `tabel lokasi`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `tabel lokasi`
--
ALTER TABLE `tabel lokasi`
